...
class ISTFT(nn.Module):
    ...
    def forward(self, X: Tensor, length: Optional[int] = None):
        ...
        reconstruct_signal = reconstruct_signal.reshape( shape[:-3]+ reconstruct_signal.shape[-1:])
...
if __name__ == '__main__':
    ...
    file_path = pathlib.Path(__file__).parent.parent.absolute() / "sounds" / "speech-female-44.1k.wav"
